...
# Python deps
pip3 install -r requirements.txt -r scripts/requirements.txt --break-system-packages

# Install Google Chrome for Playwright to bypass Ubuntu 26.04 dependency check
