    ...
    return (
        <div className="space-y-8 max-w-6xl mx-auto mt-8">
            ...
            <div className="bg-card border border-border rounded-2xl p-6">
                <h3 className="text-xl font-bold text-foreground mb-4">Fordeling av traffede targets ({activeChannel})</h3>
                {totalTP > 0 ? (
                    ...
                    <p className="text-muted-foreground text-center py-8">Ingen TP-treff registrert for denne perioden.</p>
                )}
            </div>
        </div>
    );
